...
% converting y vector into matrix with 10 classes
...
% regularization
temp3 = Theta1;
temp3(:, 1) = zeros(size(Theta1, 1), 1);
temp4 = Theta2;
temp4(:, 1) = zeros(size(Theta2, 1), 1);
Theta1_grad += lambda/m * temp3;
Theta2_grad += lambda/m * temp4;
